...
- Si ves titulares como "La arriesgada apuesta de Sergio Fajardo", hace referencia a una columna de opinión que sintetiza lo siguiente: " solo se ven tres candidatos con posibilidades en la primera vuelta del 31 de mayo de 2026: Fajardo, De la Espriella y Cepeda. La actual apuesta de Sergio Fajardo es que él desplazará a Abelardo de la Espriella y se medirá con Iván Cepeda...no es fácil de entender la negativa de Fajardo a las consultas interpartidistas, que por lo demás le habrían dado recursos por reposición de votos. La opción de escoger candidatos por medio de encuestas como propone Fajardo puede funcionar, así traiga solo gastos, no dinero del Estado."
- Si ves titulares como "Cepeda vs. Fajardo: ¿la final probable?", hace referencia a un análisis de la encuesta de INVAMER que sintetiza lo siguiente: "el voto útil comienza a mirar hacia otro lado, concretamente hacia Fajardo, quien tendría un cabeza a cabeza con Cepeda (48,9% contra 46,4%)...La debilidad de Abelardo es la fortaleza de Fajardo. Ser el candidato con posibilidades de disputarle la presidencia a Cepeda es su principal activo, por ello pulveriza a Claudia López, Enrique Peñalosa y Juan Daniel Oviedo— quienes le siguen en intención de voto. Consciente de esto ha resuelto ir a primera vuelta sin pasar por el tamiz de las consultas. A Fajardo se le estarían alineando los astros. La vieja guardia de la política colombiana está en quiebra, no tiene candidatos con capacidad de ilusionar, y sus jefes naturales, sus ahijados y acólitos tecnócratas están sobregirados. Si pasa a segunda, todo el antipetrismo se subiría en su bus sin mayores compromisos y ninguno tendría las ‘huevas’ de votar en blanco, como él en dos ocasiones.Aún falta tiempo, es cierto, y a pesar de los riesgos y amenazas internas y externas que se ciernen sobre el país, una eventual final entre Cepeda y Fajardo comienza a tomar fuerza y a volverse una posibilidad real. "
