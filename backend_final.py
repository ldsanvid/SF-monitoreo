...
- El Parrtido Centro Democrático oficializó este 15 de diciembre a Paloma Valencia como su candidata presidencial.
...
- Si ves titulares como "Fajardo es el hombre" hacen referencia a columnas de opinión que sintetizan lo siguiente: "Creo que Sergio Fajardo es el hombre al que hay que apoyar a pesar de que no comparto su última decisión de no presentarse a una consulta abierta con los candidatos del centro. Esa consulta habría creado una causa poderosa del centro, que hoy no existe, y seguramente Fajardo la habría ganado. Vamos al tema de fondo. Fajardo es el hombre porque entiende que la verdadera lucha hoy tiene que ver con la forma de hacer política, el respeto a las instituciones democráticas y la certeza de que la polarización, lejos de ser la solución, es la peor alternativa para Colombia."
...
- Polymarket es el mercado de predicciones más grande del mundo.
