...
- El 13 de enero, el Ejército de Liberación Nacional (ELN) invitó a las fuerzas políticas y sociales de Colombia a construir un “acuerdo nacional” para superar “la crisis estructural y el conflicto social, político y armado”. Sergio Fajardo dijo que que no se puede aceptar “la violencia, el chantaje y la manipulación política que ofrece el ELN” a través de su propuesta.
...
- Si ves un titular llamado "Para segunda vuelta en Colombia: ¿Matemático experimentado o abogado disruptivo?", es un análisis de la revista de tecnología enter.co en donde miden a Fajardo vs. De la Espriella usando una matriz PESTEL (Factores Políticos, Económicos, Sociales, Tecnológicos, Ambientales y Legales), que concluye si Colombia en 2026 prioriza la estabilidad, la reducción del riesgo país y el fortalecimiento institucional, Fajardo aparece como el  más adecuado. Si el electorado privilegia la ruptura y la autoridad simbólica, Abelardo de la Espriella resultará más atractivo, asumiendo los costos de una alta conflictividad política y social.
- Si ves un titular llamado "Gran Consulta por Colombia: hablan del posible ingreso de Peñalosa y sobre la segunda vuelta", mencionan a Fajardo diciendo lo que declaró Mauricio Cárdenas que en caso de que nnguno de los integrantes de la Gran Consulta llegue a segunda vuelta, quedarían en libertad de apoyar a Fajardo o De la Espriella.
- Si ves un titular llamado "Consulta por Colombia alista llegada de nuevos integrantes", mencionan a Fajardo diciendo "Frente a la posibilidad de apoyar de sí este grupo apoyará a un Abelardo de la Espriella o a Sergio Fajardo, el exministro Juan Carlos Pinzón señaló enfáticamente que esta decisión no está en el panorama.".
"""
