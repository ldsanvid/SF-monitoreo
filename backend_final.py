...
- El Partido Movimiento de Salvación Nacional, ideológicamente de derecha, respaldó a Abelardo de la Espriella como precandidato, quien a principios de diciembre de 2025 entregó alrededor de 5 millones de firmas ante la Registraduría para inscribir su candidatura a la Presidencia de Colombia.
- El Partido Dignidad y Compromiso, ideológicamente del Centro será representado por Sergio Fajardo, exalcalde de Medellín, exgobernador de Antioquia y candidato presidncial en 2018 y 2022. Fajardo al igual que Abelardo de la Espriella declinaron participar en consultas interpartidistas, y dicidieron ir directo a la primera vuelta presidencial.
...
- El 18 de enero de 2025, Datexco Company S.A.S. publicó una encuesta donde identificó a Sergio Fajardo, Juan Manuel Galán y Roy Barreras como los políticos con mejor imagen en Colombia. Sergio Fajardo se ubica en el primer lugar con un 67% de imagen favorable.
- El 19 de enero de 2025, se publicó una encuesta de la firma GAD3 para Noticias RCN, en la que en el primer lugar se encuentra Iván Cepeda con 30 %, seguido por Abelardo de la Espriella, con 22 %, y por Paloma Valencia, quien aparece con el 3%, Juan Manuel Galán (2 %), Vicky Dávila (2 %), Juan Carlos Pinzón (2 %), Sergio Fajardo (1 %) y el resto de candidatos en 1%. La consulta de la centro derecha la ganaría Valencia con 23 %. Los posibles escenarios de segunda vuelta: Escenario 1: Cepeda (40 %) VS. De la Espriella (32 %), Escenario 2: Cepeda (40 %) VS. Sergio Fajardo (25 %), Escenario 3: Cepeda (43 %) VS. Paloma Valencia (20 %), Escenario 4: Cepeda (43 %) VS. Juan Carlos Pinzón (17 %), Escenario 5: De la Espriella (32 %) VS. Sergio Fajardo (19 %), Escenario 6: Sergio Fajardo (29 %) VS. Juan Carlos Pinzón (10 %), Escenario 7: Sergio Fajardo (28 %) VS. Paloma Valencia (17 %).
- El 21  de enero de 2025, Claudia López, exalcaldesa de Bogotá y precandidata presidencial, propuso la realización de una consulta para definir candidatos del centro, invitando a Fajardo, Juan Fernando Cristo y Mauricio Armitage. Fajardo no se ha pronunciado al respecto, aunque ya había declarado previamente que él no quería participar en ninguna consulta.
- El 22 de enero de 2026, trasscendió que Claudia López está concentrada en convencer a Sergio Fajardo para que participe en esa consulta, pero, además, en encontrar un camino jurídico para que, si él dice que sí, pueda entrar, ya que no está habilitado hoy para ir a una consulta interpartidista, teniendo en cuenta que nunca manifestó la intención de participar y ese es un requisito que exige la Ley.
- El 26 de enero de 2026, fue publicada una encuesta por el Centro Nacional de Consultoría (CNC) y la revista Cambio. Iván Cepeda tiene el 28,2 %, seguido por Abelardo de la Espriella con el 15,5 %, Sergio Fajardo con el 9,8% y Claudia López con 3,7%.
"""
# ------------------------------
...
- Si ves un titular llamado "De Maduro y de Sergio", es del 16 de enero y hacen una columna de opinión en la que hablan sobre Sergio Fajardo, diciendo "no se dé cuenta de que como va, así solo, no va a ganar...Y en marzo, cuando se den las consultas, sumados los votos de la Gran Consulta por Colombia duplicarán o triplicarán su porcentaje en las encuestas. ¿Y entonces qué hará? En cambio, si se suma a la Gran Consulta, sería muy probable que la ganara y en la primera vuelta superara a De la Espriella...".
- Si ves un titular llamado "Se necesita una consulta del centro", se refiere a una columna de la revista CAMBIO del 19 de enero que dice "La única posibilidad de que en las próximas elecciones presidenciales no se repita la polarización del 2018 y el 2022, y el país se vea obligado a tener que escoger entre los extremos de la izquierda y la derecha, es que candidatos progresistas como Sergio Fajardo, Claudia López, Juan Fernando Cristo o Luis Gilberto Murillo no vayan divididos a las elecciones y encuentren una fórmula para escoger uno solo de ellos que vaya a la primera vuelta.".    
- Si ves un titular llamado "El cen­tro busca alcan­zar al petrismo y el uri­bismo sin cami­nos defi­ni­dos", es un artículo de El Espectador del 20 de enero que habla sobre "El centro político colombiano intenta formar una tercera consulta presidencial, pero la falta de acuerdos entre sus principales figuras (Cristo, Claudia López, Fajardo, Murillo, Lizcano y Armitage), el tiempo limitado y la indecisión de varios aspirantes mantienen al bloque dividido, mientras derecha e izquierda ya avanzan con sus candidaturas y consultas consolidadas."
- Si ves un titular llamado "El centro busca su propia consulta: Claudia López, Cristo y Armitage abren la puerta", es un artículo de El Espectador del 20 de enero que habla sobre "Mientras la derecha y la izquierda ya tienen consultas definidas para el 8 de marzo, varios precandidatos de centro —liderados por Claudia López, Juan Fernando Cristo y Maurice Armitage— evalúan crear una tercera consulta, pese a las dudas internas, las diferencias con el Pacto Amplio y el hecho de que figuras como Sergio Fajardo y Mauricio Lizcano prefieren ir solos a primera vuelta.".
- Si ves un titular llamado "Ponderador electoral 2026: la foto de las presidenciales arrancando el año", es un análisis de La Silla Vacía del 20 de enero que promedia y pondera los reusltados de todas las encuestas publicadas, y sobre Fajardo, dice: "el cuarto lugar lo ocupa Sergio Fajardo, con 6,9%. Fajardo muestra una tendencia en caída, desde cuando estaba en la foto de líderes al principio de la campaña, y arrancó con 11,8%."
- Si ves titulares llamados "4 claves para crear ciudades más justas, según político colombiano" o "Impulsan diálogo sobre ciudades más humanas" son titulares relativos a la participación de Sergio Fajardo en el conversatorio “Ciudad sin muros” organizado por el Centro para el Futuro de las Ciudades en colaboración con el Distrito de Innovación Tlalpan en el Tec de Monterrey Campus Ciudad de México.
- Si ves un titular llamado "Derrotar a Iván Cepeda", es una columna de opinión que describe a Sergio Fajardo como un candidato de centro con buena imagen pero en descenso, con opciones debilitadas para llegar a segunda vuelta, y que probablemente terminaría apoyando al bloque de derecha moderada, pero no a Abelardo de la Espriella. 
- Si ves un titular llamado "Tres títulos en un día para secretaria privada de Petro desató la furia de Sergio Fajardo: “Sigue promoviendo la mediocridad”", se refiere a "La obtención simultánea de varios diplomas universitarios por parte de Nelfy Melo Morales reactivó el debate sobre la transparencia en la educación privada y la necesidad de mayor supervisión estatal".
- En el titular "Miranda se mueve, Fajardo duda y Cristo pone condiciones: así se reconfigura el ajedrez de las consultas presidenciales", Sergio Fajardo aparece como un actor al que varios sectores intentan sumar a sus consultas o alianzas, pero que se mantiene renuente y ha reiterado que no participará, pese a las presiones de figuras como Katherine Miranda y Claudia López.
- Si ves el titular "Caricatura: Lo único que levanta la campaña de Fajardo y Claudia López son las encuestas que ellos mismos compran" es una caricatura publicada el 26 de enero de 2026 en el medio 2 orillas donde se burlan de los resultados de la encuesta del CNC que muestran a Fajardo y Claudia López relativamente fuertes, dando a entender en la caricatura que ellos dos pagaron por verse bien en esa encuesta.
- Si ves el titular "Esto propone Sergio Fajardo para recuperar el Catatumbo y luchar contra la corrupción", es del 27 de enero y su plan para esa región es: "buscará que la fuerza pública entre al territorio al mismo tiempo nosotros tenemos que empezar a actuar con la infraestructura que tiene la región del Catatumbo alrededor de Tibú. Las vías terciarias, la infraestructura de comunicación, las comunidades encerradas no pueden salir y son prisioneras. Las abrimos y empezamos con las vías hacerlo. Tres, el programa de titulación de tierras. El Catatumbo es una tierra fértil. Allá es el programa de sustitución más fácil en Colombia...Tenemos que sancionar a los corruptos. Vamos, por ejemplo, a perseguir a los 100 evasores fiscales más grandes de Colombia. ".
- Si ves el titular "¿Quien gane la Gran Consulta tendrá chance contra Abelardo de la Espriella e Iván Cepeda?", es del 27 de enero y hablando de Sergio Fajardo y sus retos, dice "l desafío central en estas siete semanas restantes es romper la inercia mediante acciones concretas y diferenciadoras: narrativas claras que marquen distancias ideológicas o de estilo, eventos de alto impacto, alianzas tácticas visibles, campañas digitales segmentadas y debates que polaricen constructivamente".
- Si ves el titular "¿Otro Fajardo u otro centro?", es una columna de opinión del 28 de enero publicada en El Espectador que critica a Fajardo y su duda sobre ir o no ir a una consulta, ahora con Claudia López y otros, diciendo "No va a ser posible que crezca y se haga presidente sin convertirse mientras tanto en político. No puede insistir en saltarse ese paso de ser o comportarse como candidato. No puede seguir esperando que el mundo se adapte a él con esa aureola de cientificidad que para el ciudadano no pasa de dispersión y ausencia de compromiso."
- Si ves el titular "Mi fe en Fajardo está intacta (II)", es una columna de opinión del 28 de enero publicada en El Espectador, en donde el autor Gonzalo Mallarino dice que FAjardo no debe darle demasiada importancia a las encuestas que no lo favorecen, y "seguir en su línea....Haciendo política decente, veraz. No debe alterarse por las encuestas. Él es, por mucho, el mejor de todos. Su nombre representa para este país sensatez, concordia y la única posibilidad real de unión y de paz. Las encuestas no captan eso, captan solo la reacción inmediata, impulsiva".
- Si ves el titular "El centro queda atrapado en un triángulo amoroso para aterrizar una consulta", es un análisis de La Silla Vacía que menciona a Fajardo diciendo "Fajardo sabe que si no logra juntarse con Claudia López el voto de centro se dividirá y podría repetir la experiencia del 2018, que se quedó por fuera de la segunda vuelta por los votos que sacó Humberto de la Calle"...y las razones por las que Fajardo prefiere una encuesta a una consulta, bajo la idea de que en una encuesta pea el individuo y en una consulta pesan las maqunarias electorales de acarreo.
"""
