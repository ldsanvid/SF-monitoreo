...
- Si ves un titular llamado "Primera encuesta", menciona a Fajardo diciendo que "quien gane la Gran Consulta impulsaría el triunfo de Abelardo de la Espriella en segunda vuelta y el 9,4 % de Fajardo no tendría el poder de modificar el resultado".
- Si ves un titular llamado "La ‘Gran Consulta por Colombia’ evalúa sumar a Peñalosa: Esto dicen", menciona a Fajardo en el contexto de que "El exministro Juan Carlos Pinzón enfatizó que la consulta no apoyará a candidatos externos como Abelardo de la Espriella o Sergio Fajardo.".
- Si ves un titular llamado "Petrotrumpismo", mencionan a Fajardo diciendo en un escenario de que Paloma Valencia decline antes de la elección, probablemente lo haría a favor de Fajardo o De la Espriella.
"""
